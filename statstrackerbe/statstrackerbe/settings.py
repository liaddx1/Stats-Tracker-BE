"""
Django settings for statstrackerbe project.
...
SECRET_KEY = "django-insecure-(zfx@gps^x^%+5a88v!brtw68id30le@(n0^++(=+f^0*+t1(a"
...
ROOT_URLCONF = "statstrackerbe.urls"
...
WSGI_APPLICATION = "statstrackerbe.wsgi.application"
